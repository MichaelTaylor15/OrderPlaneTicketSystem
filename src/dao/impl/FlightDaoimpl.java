...
public class FlightDaoimpl implements IFlightDao {
    ...
    public Flight getFlightBydepartureAirPort(String departureAirPort) throws SQLException {
        ...
        while (rs.next()) {
            ...
            String flightId = rs.getString("FLIGHT_ID");//航班号

            String planeType = rs.getString("PLANE_TYPE");//机型

            int currentSeatNum = rs.getInt("TOTAL_SEATS_NUM");//当前空位

            String departureTime = rs.getString("DEPARTURE_AIRPORT");//起飞时间

            String destinationAirport = rs.getString("DESTINATION_AIRPORT");//目的地机场
    ...
    public Flight getFlightByDestinationAirPort(String destinationAirPort) throws SQLException {
        ...
        ptmt.setString(1, destinationAirPort);
        ResultSet rs = ptmt.executeQuery();
        while (rs.next()) {
            ...
            String departureAirport = rs.getString("DEPARTURE_AIRPORT");//起飞机场
